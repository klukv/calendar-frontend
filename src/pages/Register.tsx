...
import { initialValuesMessage, signin } from "../const/const";
import "../css/auth.css";
...
const Register: React.FC = () => {
  ...
  return (
    <div className="register auth">
      <form className="register__inner auth__inner">
        {!message.success && (
          <>
            ...
            <div className="register__btn btn-auth">
              <button
                type="button"
                className="register__button button-auth"
                onClick={Register}
              >
                Зарегистрироваться
              </button>
        ...
        {message.success && (
          <Link to={signin} className="button__succes button-auth">
            Авторизироваться
          </Link>
        )}
      </form>
